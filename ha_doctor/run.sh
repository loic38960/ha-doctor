...
bashio::log.info "Starting HA Doctor 0.8.4"
...
bashio::log.info "Controller Protocols detect helper-mediated phase handoffs before flagging conflicts"
...
bashio::log.info "Score V5 remains preview-only; stable Score V4 history remains untouched"
bashio::log.info "Consistency V4 checks Flow metadata, post-Flow architecture, temporal semantics and lineage privacy"
...
exec python3 -u /app/app_v084.py
