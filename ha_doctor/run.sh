...
bashio::log.info "Starting HA Doctor 0.8.7"
...
bashio::log.info "Controller Review Summary V1 separates entity counts from unresolved pair counts"
...
bashio::log.info "Consistency V5.1 cross-checks controller summary identity in addition to existing report invariants"
...
exec python3 -u /app/app_v087.py
